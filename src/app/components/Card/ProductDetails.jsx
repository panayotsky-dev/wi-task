    ...
    <div className='mt-[32px]  grid grid-cols-2'>
            <div className=' pr-[36px]'>
                ...
                <div className='flex flex-row justify-between mt-[8px]'>
                    ...
                    <button onClick={() => setSelectedSize('XS')} className={`${selectedSize === 'XS' ? " bg-[#EDA3B5] w-[60px] h-[44px]  text-white" : "border-gray-200 border-2"} w-[60px] h-[44px]   rounded-md text-[#1B2437] `}>XS</button>
                    <button onClick={() => setSelectedSize('S')}  className={`${selectedSize === 'S' ? " bg-[#EDA3B5] w-[60px] h-[44px]  text-white" : "border-gray-200 border-2"} w-[60px] h-[44px]  rounded-md text-[#1B2437] `}>S</button>
                    <button onClick={() => setSelectedSize('M')}  className={`${selectedSize === 'M' ? " bg-[#EDA3B5] w-[60px] h-[44px]  text-white" : "border-gray-200 border-2"} w-[60px] h-[44px]   rounded-md text-[#1B2437] `}>M</button>
                </div>
            </div>
